...
export const handleUpdateBookingSection = asyncHandler(async (req, res) => {
    ...
    const userId = req.user?.userId ?? "000000000000000000000000";
    const booking = await updateBookingSectionService(id, section, data, userId);
    res.status(200).json({
        success: true,
...
export const handleGetBookingByNumber = asyncHandler(async (req, res) => {
